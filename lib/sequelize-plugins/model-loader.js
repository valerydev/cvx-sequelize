...
module.exports = function(sequelize, opts) {
  ...
  sequelize.import = _.wrap(sequelize.import, function($import, logicDir, attribsDir){
    var splitted = attribsDir ? true:false;
    ...
    .forEach( modelFile => {
      ...
      if(splitted) {
        ...
        var baseAttribs  = modelAttribs[0];
        var baseOpts     = modelLogic  [1];
        var otherAttribs = modelLogic  [0];
        var otherOpts    = modelAttribs[1];
    ...
    sequelize.models[Symbol.iterator] = function*(){
