...
module.exports.wrapAssociations = function(models){
    ...
    models.forEach(function(model){
        ...
        var associationWrapper = function(assocFunc, target, opts){
            ...
            //En un scope de asociacion queremos que puedan utilizarse los nombres de atributos del modelo
            //sequelize no soporta esto, asi que nosotros mapeamos aqui los nombres de atributos a nombres de campo
            if(opts.scope) {
...
module.exports.addJSONSchema = function (models) {
    ...
    var modelAttribs = require('../lib/models/attribs')({
        NUMBER: function(){
          return 'number';
        },
        BIGINT: function(){
