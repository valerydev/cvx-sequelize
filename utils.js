...
module.exports.addMixins = function(models) {
  _.extend(models.Sequelize.Instance.prototype, mixins.Instance);
};
...
var mixins = {
  Instance: {
    updateAssoc: function (opts) {
      ...
      var alias  = opts.as;
      var data   = opts.values ? _.flatten([opts.values]) : [];
      var tap    = opts.tap;
      ...
      return data.map(function(values){
        ...
        return self._doOperation(association, self, targetInstance);
      });

    },

    _markOperation: function (values) {
      var op = 'C';
    ...
    _doOperation: function (association, sourceInstance, targetInstance) {
